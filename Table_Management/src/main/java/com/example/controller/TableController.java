...
//            @RequestParam String newTableName,
    ...
    public ResponseEntity<Void> addColumn(@RequestParam String tableName, @RequestParam List<String> columnNames,
            @RequestParam List<String> dataTypes) {
    	tableService.addColumns(tableName, columnNames, dataTypes);
        return ResponseEntity.ok().build();
    }

    @PostMapping("/removeColumn")
    public ResponseEntity<Void> removeColumn(@RequestParam String tableName, @RequestParam String columnName) {
